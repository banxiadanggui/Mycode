...
def solve(area_dict: dict[list], area: dict,crop_dict: dict[list],promised, price, cost, per):
    ...
    print(model)
    file_name='result1_1.xlsx'#添加了相对路径，使用时可更改
...
def main():
    ...
    solve(area_dict,area, crop_dict, promised, price, cost, per)
